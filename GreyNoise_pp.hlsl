...
float4 main(PostProcessingInput input) : SV_Target
{
    ...
    float grey = sceneColour.r + sceneColour.g + sceneColour.b / 3/*FILTER - not 0, but a method to convert the r,g & b of texColour to a single grey-scale value (result in range 0->1)*/;
